PR_USECOL = ['PRSN', 'APPL_CAT', 'APPL', 'POS', 'TYPE', 
             'IS_7-1',
             'EA', 'LA', 'TC', 'SDC', 
             'QTY', 'ERT', 'DEPS',
...
PR_RENAMED = ['PRSN', 'applicantCategory', 'applicantName', 'position', 'type',
                'is_7_1', 'equipmentArea', 'landArea', 'totalCapacity', 'singleDeviceCapacity', 
